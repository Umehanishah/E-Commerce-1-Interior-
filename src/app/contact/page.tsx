    ...
    <main>
        ...
        <div className="bg-[url('/shop-1.png')] h-80 bg-no-repeat">
          <div className="pt-32 md:pt-28 ">
            <div className="text-center">
              ...
              <p className="text-sm pt-3 md:pt-5 text-gray-500">
      ...
      <section>
        <div className="pt-3 md:pt-10 pb-3 md:pb-10 px-3 md:px-20 text-center">
          ...
          <p className="text-xs md:text-base text-gray-500 pt-3 md:pt-5">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente eveniet laboriosam <br />
            aliquid, harum, minima modi aperiam quam libero id nulla eos eius omnis.
          </p>
        </div>
        ...
        <div className="flex gap-20 md:gap-40 px-5 md:px-20 pt-5 md:pt-10 pb-5 md:pb-10">
          ...
          <div>
            <div>
              <label htmlFor="name" className="block mb-2 md:mb-5 text-xs md:text-base font-medium md:font-semibold text-gray-900 dark:text-white">
                Your name
              </label>
              <input type="text" id="name" className="bg-gray-50 border border-gray-300 text-gray-900 md:px-20 text-xs md:text-base rounded-md md:rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Abc" required />
            </div>
            <div>
              <label htmlFor="email" className="block mb-2 md:mb-5 text-xs md:text-base font-medium md:font-semibold pt-3 md:pt-5 text-gray-900 dark:text-white">
                Email Address
              </label>
            ...
            <div>
              <label htmlFor="subject" className="block mb-2 md:mb-5 text-xs md:text-base font-medium md:font-semibold pt-3 md:pt-5 text-gray-900 dark:text-white">
                Subject
              </label>
              <input type="text" id="subject" className="bg-gray-50 border border-gray-300 text-gray-900 text-xs md:px-20 md:text-base rounded-md md:rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="This is an optical" required />
            </div>
            <div>
              <label htmlFor="message" className="block mb-2 md:mb-5 text-xs md:text-base font-medium md:font-semibold pt-3 md:pt-5 text-gray-900 dark:text-white">
                Your message
              </label>
            ...
            <div className="pt-3 md:pt-5">
              <button className="bg-yellow-600 pt-2 md:pt-3 pb-2 md:pb-3 px-5 md:px-20 text-sm md:text-base rounded-md text-white hover:text-black hover:bg-white hover:border-2 hover:border-yellow-600">
                Submit
              </button>
            </div>
          </div>
      ...
      <section>
        <div className="grid grid-cols-4 gap-5 pt-10 md:pt-10 px-5 md:px-20 pb-10 md:pb-10 bg-amber-50">
          ...
          <div className="flex pt-2 md:pt-2 pb-3 md:pb-5 px-2 md:px-2 h-16">
            ...
            <div>
              <h2 className="text-xs md:text-lg font-semibold">Warranty Protection</h2>
